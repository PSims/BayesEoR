...
def make_Gaussian_beam(image_size_pix, fwhm_pix, beam_peak_amplitude, center_pix=[]):
	...
	hpx_dir = '/users/jburba/data/jburba/bayes/BayesEoR/Linalg/hpx_coords/nside{}/'.format(p.nside)
	filename = 'fov-{:.1f}deg_gauss-beam_fwhm-{:.1f}deg.npy'.format(p.simulation_FoV_deg,
...
def Produce_Full_Coordinate_Arrays(nu, nv, nx, ny):
	...
	hpx_dir = '/users/jburba/data/jburba/bayes/BayesEoR/Linalg/hpx_coords/nside{}/'.format(p.nside)
	# filename = 'fov-{:.1f}deg_pix-units.npy'.format(6.5)
