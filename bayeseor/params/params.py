...
class BayesEoRParser(ArgumentParser):
    ...
    priors : list of float
        Power spectrum priors passed as a list of sublists.  Each sublist
        contains the [min, max] for the prior in each k bin.  For example, with
        2 k bins, the priors could be passed as '[[0, 1.2], [4.2, 8]]'.
