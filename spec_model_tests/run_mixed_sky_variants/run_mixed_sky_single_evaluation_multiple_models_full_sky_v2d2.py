...
if Continue:
	...
	field_index = 2
	sort_order = b1_b2_logL_array_sorted_arrays[field_index][:,2][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))].argsort()
	print b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order]
	maxL = b1_b2_logL_array_sorted_arrays[field_index][:,2][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order]
	number_of_preferred_models = np.sum((b1_b2_logL_array_sorted_arrays[field_index][:,2][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order]-maxL)>-3.)
	number_of_disfavoured_models = np.sum((b1_b2_logL_array_sorted_arrays[field_index][:,2][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order]-maxL)<-3.)
	...
	print 'best model'
	print  b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order][-1]
	print '10th ranked model'
	print  b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order][-1-10]
	print '20th ranked model'
	print  b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order][-1-20]
	print '32th ranked model'
	print  b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order][-32]
	...
	print  b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order][-59]
	print '115th ranked model'
	print  b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order][-115]
	print 'worst (231th ranked) model'
	print  b1_b2_logL_array_sorted_arrays[field_index][np.logical_not(np.isnan(b1_b2_logL_array_sorted_arrays[field_index][:,2]))][sort_order][-231]
